...
\includegraphics{Tutorials_files/figure-latex/unnamed-chunk-53-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Tutorials_files/figure-latex/unnamed-chunk-54-1.pdf}
...
\FunctionTok{boxplot}\NormalTok{(SBP }\SpecialCharTok{\textasciitilde{}}\NormalTok{ sex }\SpecialCharTok{+}\NormalTok{ treatment, DF, }\AttributeTok{at =}\NormalTok{ where, }\AttributeTok{axes =} \ConstantTok{FALSE}\NormalTok{,}
        \AttributeTok{ylim =} \FunctionTok{c}\NormalTok{(}\DecValTok{110}\NormalTok{, }\DecValTok{200}\NormalTok{),}
...
\includegraphics{Tutorials_files/figure-latex/unnamed-chunk-58-1.pdf}
...
\caption{\label{tab:unnamed-chunk-63}Sex and systolic blood pressure (SBP) of 10 individuals. <font color = 'blue'>(tidy)</font>}
\centering
\fontsize{11}{13}\selectfont
\begin{tabular}[t]{c|c}
\hline
...
\begin{figure}
\includegraphics[width=1\linewidth]{figures/typo} \caption{My hasty attempt to figure out which clothes to wear to work.}\label{fig:unnamed-chunk-65}
\end{figure}
